...
class TestimonialsTest < ApplicationSystemTestCase
  ...
  test "should create testimonial" do
    ...
    fill_in "Author name", with: @testimonial.author_name
    fill_in "Author title", with: @testimonial.author_title
    fill_in "Content", with: @testimonial.content
    fill_in "Rating", with: @testimonial.rating
  ...
  test "should destroy Testimonial" do
    visit testimonial_url(@testimonial)
    accept_confirm { click_on "Destroy this testimonial", match: :first }
