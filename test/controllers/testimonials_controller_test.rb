...
class TestimonialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create testimonial" do
    assert_difference("Testimonial.count") do
      post testimonials_url, params: { testimonial: { author_name: @testimonial.author_name, author_title: @testimonial.author_title, content: @testimonial.content, rating: @testimonial.rating } }
    end
  ...
  test "should update testimonial" do
    patch testimonial_url(@testimonial), params: { testimonial: { author_name: @testimonial.author_name, author_title: @testimonial.author_title, content: @testimonial.content, rating: @testimonial.rating } }
