...
class DestinationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create destination" do
    assert_difference("Destination.count") do
      post destinations_url, params: { destination: { country: @destination.country, description: @destination.description, featured: @destination.featured, name: @destination.name } }
    end
  ...
  test "should update destination" do
    patch destination_url(@destination), params: { destination: { country: @destination.country, description: @destination.description, featured: @destination.featured, name: @destination.name } }
