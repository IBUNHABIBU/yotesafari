...
class HerosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hero" do
    assert_difference("Hero.count") do
      post heros_url, params: { hero: { description: @hero.description, subtitle: @hero.subtitle, title: @hero.title } }
    end
  ...
  test "should update hero" do
    patch hero_url(@hero), params: { hero: { description: @hero.description, subtitle: @hero.subtitle, title: @hero.title } }
