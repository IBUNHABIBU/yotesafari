...
class TeamMembersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create team_member" do
    assert_difference("TeamMember.count") do
      post team_members_url, params: { team_member: { bio: @team_member.bio, display_order: @team_member.display_order, name: @team_member.name, title: @team_member.title } }
    end
  ...
  test "should update team_member" do
    patch team_member_url(@team_member), params: { team_member: { bio: @team_member.bio, display_order: @team_member.display_order, name: @team_member.name, title: @team_member.title } }
